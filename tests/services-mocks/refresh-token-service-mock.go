...
// Source: internal/app/contracts/refresh-token-service.go
//
// Generated by this command:
//
//	mockgen -source=internal/app/contracts/refresh-token-service.go -destination=tests/services-mocks/refresh-token-service-mock.go -package=servicesmocks
//
