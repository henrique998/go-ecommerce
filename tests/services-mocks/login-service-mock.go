...
// Source: internal/app/contracts/login-service.go
//
// Generated by this command:
//
//	mockgen -source=internal/app/contracts/login-service.go -destination=tests/services-mocks/login-service-mock.go -package=servicesmocks
//
