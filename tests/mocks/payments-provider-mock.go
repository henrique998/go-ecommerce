...
// Source: internal/app/contracts/payments-provider.go
//
// Generated by this command:
//
//	mockgen -source=internal/app/contracts/payments-provider.go -destination=tests/mocks/payments-provider-mock.go -package=mocks
//
